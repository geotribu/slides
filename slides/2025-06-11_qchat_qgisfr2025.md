...
- Ouvrir QGIS puis installer le plugin [`QTribu`](https://plugins.qgis.org/plugins/qtribu/)
...
![QGIS 4 - Raclette without compromise](https://cdn.geotribu.fr/img/articles-blog-rdp/memes/kuhgis4_raclette_without_compromise.png)
...
_Remerciement spécial à [@nirvn](https://github.com/nirvn) et [@Guts](https://github.com/guts) :thumbsup:_
